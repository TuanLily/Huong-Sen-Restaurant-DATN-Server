...
//     const { dishes, dishList, customerInfo, currentTotal } = req.body;
...
//                 <li><strong>Tổng tiền sau thay đổi:</strong> ${formatCurrency(currentTotal)}</li>
//                 <li><strong>Tiền phải trả sau khi đến ăn:</strong> ${formatCurrency(currentTotal - customerInfo.deposit)}</li>
//             </ul>
